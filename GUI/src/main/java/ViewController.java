...
public class ViewController extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1 = new javax.swing.JTextField(result);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        amountPressed++;
        if(isChanged==true){
        inputan = strb.toString();
        cache=mymodel.signatureToWords(inputan);
        String[] show=cache.toArray(new String[cache.size()]);
        result=show[0];
        isChanged=false;
        }else{
            String[] show=cache.toArray(new String[cache.size()]);
            result=show[amountPressed];
            isChanged=false;
        }
